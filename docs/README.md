...
| Document | Purpose |
|----------|---------|
| **[`requirements.md`](./requirements.md)** | Canonical product requirements (REQ-*) |
| **[`FOUNDATION.md`](./FOUNDATION.md)** | Architecture, master-data redesign, schema map, phase plan, blockers |
