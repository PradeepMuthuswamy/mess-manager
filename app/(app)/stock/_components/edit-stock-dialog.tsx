...
import { updateLotAction, adjustQtyAction } from '@/lib/stock/actions';
import { containerLabel, pluralize } from '@/lib/stock/compute';
...
export function EditStockDialog({
  ...
  return (
    <AdaptiveModal
      ...
      description={`Update ${lot.item_name ?? 'this lot'}'s price and source. Each price is a separate lot — change this one only to fix a mistake.`}
    >
